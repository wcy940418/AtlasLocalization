...
public:
  ...
  Demo() :
    ...
    m_height(480),
/*--------------------------------------------------------------------------------------------------------------------------------------------------------
m_tagSize has influence over size of image expected
default 0.166
----------------------------------------------------------------------------------------------------------------------------------------------------------
*/
    m_tagSize(0.166),
...
//new code?
//I really don't know what size to put
//don't blame me
    double tagSize;
    switch(detection.id){
        case 0:
    ...
    detection.getRelativeTranslationRotation(tagSize, m_fx, m_fy, m_px, m_py,translation, rotation);
...
//    wRo_to_euler(fixed_rot, yaw, pitch, roll);
    wRo_to_euler(fixed_rot, roll, yaw, pitch);
    cout << "  distance=" << translation.norm()
         ...
         << endl;
/*
    cout<<"distance squared"<<translation.norm()*translation.norm()
        <<"x*x+y*y+z*z"<<translation(0)*translation(0)+translation(1)*translation(1)+translation(2)*translation(2)
        <<endl;
*/
